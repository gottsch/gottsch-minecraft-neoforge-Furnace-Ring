 ...
 */
public abstract class BaseFurnaceRingMenu extends AbstractFurnaceRingMenu {
    // a reference to the stack instance being displayed by this menu
    private final ItemStack stack;

    // server constructor
    public BaseFurnaceRingMenu(MenuType<?> menuType, RecipeType<? extends AbstractCookingRecipe> recipeType, RecipeBookType recipeBookType,
                                      int containerId, Inventory playerInv, ItemStack stack) {

        super(menuType, recipeType, recipeBookType, containerId, playerInv, createContainer(stack), createData(stack));
        this.stack = stack;
    }
