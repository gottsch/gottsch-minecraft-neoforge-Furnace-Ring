package mod.gottsch.neoforge.furnacering.core.util;
...
public class LangUtil {
	...
	public static void appendAdvancedHoverText(List<Component> tooltip, Consumer<List<Component>> consumer) {
		LangUtil.appendAdvancedHoverText(FurnaceRing.MOD_ID, tooltip, consumer);
	}
	
    public static String name(String prefix, String suffix) {
    	return name(FurnaceRing.MOD_ID, prefix, suffix);
    }
    ...
    public static String item(String suffix) {
    	return name(FurnaceRing.MOD_ID, "item", suffix);
    }
    
    public static String tooltip(String suffix) {
    	return name(FurnaceRing.MOD_ID, "tooltip", suffix);
    }
    
    public static String screen(String suffix) {
    	return name(FurnaceRing.MOD_ID, "screen", suffix);
    }

	public static String chat(String suffix) {
		return name(FurnaceRing.MOD_ID, "chat", suffix);
	}
}
